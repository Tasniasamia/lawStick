...
const BlogCard = ({data}) => {
    ...
    return (
             <div className="xl:max-w-[424px] lg:max-w-full group max-w-[424px] h-full mx-auto bg-white flex flex-col items-center text-black gap-3 rounded-[10px] border   relative">
                       ...
                       {/* div 2 */}
                       <div className="sm:p-6 p-5  lg:text-start text-center flex flex-col ">
                         <p className="font-medium lg:text-lg text-base group-hover:text-[#B68C5A] text-[#242628] line-clamp-2 ">
                           {data?.title}
                         </p>
                         <p className="font-medium text-base text-[#3A3D3F] my-[12px]">
                           Update {data?.date}
                         </p>
