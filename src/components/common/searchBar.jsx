...
const SearchBar = ({className, wrapperClassName, value, onChange, placeholder}) => {


    return (
<div className={`relative flex mr-2 xl:w-[393px] w-full mb-[40px] items-center  searchBar  ${wrapperClassName || ''}`}>
