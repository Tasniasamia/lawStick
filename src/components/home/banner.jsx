        ...
        <div className="flex md:flex-row flex-col h-full custom-container lg:gap-[100px] gap-[50px]">
          <div className="xl:basis-2/3 lg:basis-1/2 md:basis-full">
            <div className="flex flex-col justify-center text-start w-full md:pb-16 xl:pt-[230px] lg:pt-[200px] md:pt-[120px] sm:pt-[80px] pt-[40px] pb-10">
              ...
              <p className="md:text-lg sm:text-base text-sm font-medium sm:mb-[13px] mb-2 px-4 sm:px-0">
                Dependable Legal Support with Unwavering Dedication
              </p>
              
              {/* Main title - Improved spacing and readability for mobile */}
              <h1 className="hero-title 2xl:text-[64px] xl:text-[55px] lg:text-[48px] md:text-[32px] text-[26px] leading-[1.3] font-normal xl:leading-[76px] lg:leading-[60px] md:leading-[40px] px-4 sm:px-0">
              ...
              <p className="lg:text-base md:mt-0 xs:mt-[-90px] mt-[-115px] md:text-sm  md:text-start text-center text-base font-normal md:pt-[13px] pt-0 2xl:w-[666px] xl:w-[600px] lg:w-[500px] w-full px-4 sm:px-0">
