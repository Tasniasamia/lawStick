...
const Banner = () => {
  ...
  useEffect(() => {
    ...
    tl.from(".right-section2", {
      y: "100%",
      opacity: 0,
      duration: 1,
      ease: "power3.out",
    },"<0.5");
    tl.from(".right-section3", {
      x: "100%",
      opacity: 0,
      duration: 1,
      ease: "power3.out",
  ...
  return (
    ...
    >
        ...
        <div className="flex md:flex-row flex-col h-full custom-container lg:gap-[100px] gap-[50px]">
          <div className="xl:basis-2/3 lg:basis-1/2 md:basis-full">
            <div  className="flex  flex-col justify-center text-start w-full md:pb-16 xl:pt-[230px]  md:pt-[100px] sm:pt-[80px] pt-[40px] pb-10">
              ...
              <p className="md:text-lg section-basic sm:text-[18px] text-sm font-medium sm:mb-[13px] mb-2 px-4 sm:px-0 leading-[21.18px] tracking-widest">
                Dependable Legal Support with Unwavering Dedication
              </p>
              
              {/* Main title - Improved spacing and readability for mobile */}
              <h1 className="hero-title section-basic title 2xl:text-[64px] xl:text-[55px] lg:text-[48px] md:text-[32px] text-[26px] leading-[1.3] font-normal xl:leading-[76px] lg:leading-[60px] md:leading-[40px] px-4 sm:px-0">
              ...
              <div className="h-[360px] section-basic relative w-full md:hidden block mt-6 mb-4 translate-y-[-80px] ">
                <img
              ...
              <p className="lg:text-base section-basic md:mt-0 xs:mt-[-90px] mt-[-115px] md:text-sm  md:text-start text-center text-sm font-normal md:pt-[13px] pt-0 2xl:w-[666px] xl:w-[600px] lg:w-[500px] w-full px-4 sm:px-0">
              ...
              <div className="lg:mt-10 section-basic sm:mt-5 mt-6 px-4 sm:px-0 grid md:place-content-start place-content-center">
      ...
      <div className="md:flex hidden h-full">
        ...
        <div className="md:basis-1/2 basis-full">
          <div className="relative right-section1 hero-images h-full">
            <img
              className="right-section2 absolute hero-image-shape bottom-0 hidden md:block xl:h-[828px] 2xl:right-[80px] right-0 2xl:w-[773px] xl:w-[690px]"
              src="./images/banner-bg-image.png"
              alt="..."
            />
            <img
              className="right-section3 absolute bottom-0 hidden md:block translate-x-1/2 right-1/2"
              src="./images/ban-image.png"
              alt="..."
            />
          </div>
