      ...
      <div className="custom-container  py-[75px] plan-section ">
        <div className="lg:flex lg:flex-row grid sm:grid-cols-2 grid-cols-1 lg:gap-0 gap-8 sm:align-items-start align-items-center justify-between  text-center  text-white">
          ...
          <div className="flex flex-col items-center xl:pe-[92px] lg:pe-[30px] bg">
            <div className="flex items-center gap-[30px]">
              <span className="text-gold text-4xl mb-2">
                <img src="./images/caseStatus1.png" alt="case" className="h-[50px] w-[50px]"/>
              </span>
              <div>
                <h3 className="text-[32px] leading-[41.76px] tracking-[4%] font-bold mb-4 ">162</h3>
          ...
          <div className="flex flex-col items-center xl:px-[92px] lg:px-[30px]">
            <div className="flex items-center gap-[30px]">
              <span className="text-gold text-4xl mb-2">
                <img src="./images/caseStatus2.png"  alt="case" className="h-[50px] w-[50px]"/>
              </span>
              <div>
                <h3 className="text-[32px] leading-[41.76px] tracking-[4%] font-bold mb-4">160</h3>
          ...
          <div className="flex flex-col items-center xl:px-[92px] lg:px-[30px]">
            <div className="flex items-center gap-[30px]">
              <span className="text-gold text-4xl mb-2">
                <img src="./images/caseStatus3.png" alt="case" className="h-[50px] w-[50px]"/>
              </span>
              <div>
                <h3 className="text-[32px] leading-[41.76px] tracking-[4%] font-bold mb-4">262</h3>
          ...
          <div className="flex flex-col items-center xl:ps-[92px] lg:ps-[30px]">
            <div className="flex items-center gap-[30px]">
              <span className="text-gold text-4xl mb-2">
                <img src="./images/caseStatus4.png"  alt="case" className="h-[50px] w-[50px]"/>
              </span>
              <div>
                <h3 className="text-[32px] leading-[41.76px] tracking-[4%] font-bold mb-4">62</h3>
