            ...
            <div className="border rounded-[20px] md:px-10 px-5 md:py-10 py-5 md:min-h-[649px]">
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="font-medium work-sans">
                  ...
                  Association.Certified Mediator: Skilled in alternative dispute
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="font-medium work-sans text-[#818B8F]">
                  ...
                  <p className="text-[#3A3D3F]">
                    ...
                    Party A and Party B, focusing on evidence, motive, and legal
                    proceedings to determine accountability.
                  </p>
                </p>
                <p className="font-medium work-sans">
                ...
                <p className="font-medium work-sans flex items-center">
                  ...
                  <Button className="border-none text-[#C7A87D] font-medium work-sans">
