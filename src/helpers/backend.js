...
// marketing group
export const fetchMarketingGroup = (data) => get("/marketing/groups", data);
...
// user subscription
export const fetchSubscriptionList = (data) => get("/subscription/user-history", data);
...
// revenue settings
export const fetchRevenueSettings = (data) => get("/revenue", data);
export const postRevenueSettings = (data) => post("/revenue", data);
// vendor product
export const fetchVendorProduct = (data) => get("/product/list/vendor", data);
export const singleproductvendor = (data) => get("/product/details", data);
export const postVendorProduct = (data) => post("/product/add", data);
export const updateVendorProduct = (data) => post("/product/update", data);
export const deleteVendorProduct = (data) => del("/product/delete", data);
export const getVendorShop=(data)=>get("/product/vendor/details",data);
// vendor order
export const fetchVendorOrder = (data) => get("/suborder/all", data);
export const fetchVendorOrderDetails = (data) => get("/suborder/details", data);
export const updateVendorOrderStatus = (data) => get("/suborder/update-status", data);

// vendor warehouse
export const fetchVendorWarehouse = (data) => get("/warehouse/list", data);
export const postVendorWarehouse = (data) => post("/warehouse/create", data);
export const fetchhublist = (data) => get("/hub/list/vendor", data);
export const delwarehouse = (data) => del("/warehouse/delete", data);
export const fetchsingleWarehouse = (data) => get("/warehouse/details", data);

// vendor withdrow List 
export const fetchWalletHistoryList = (data) => get("/wallet/vendor/list", data);
export const fetchVendorWithdrow = (data) => get("/withdraw/method/list", data);
export const postVendorWithdrowMethod = (data) => post("/withdraw/method/create", data);
export const delWithdrowMethod = (data) => del("/withdraw/method/delete", data);
export const postVendorWithdrow = (data) => post("/withdraw/create", data);
export const fetchVendorWithdrowList = (data) => get("/withdraw/list", data);

// vendor coupon 
export const fetchCouponList = (data) => get("/coupon/vendor/list", data);
export const postCoupon = (data) => post("/coupon/add", data);
export const couponStatus = (data) => post("/coupon/status", data);
export const delCoupon = (data) => del("/coupon/delete", data);


// admin hub
export const fetchAdminHub = (data) => get("/hub/list", data);
export const postAdminHub = (data) => post("/hub/create", data);
export const deleteAdminHub = (data) => del("/hub/delete", data);
export const hubstatus = (data) => get("/hub/status", data);
export const singleAdminHub = (data) => get("/hub/single", data);

// admin warehouse
export const fetchvendorWirehouse = (data) => get("/warehouse/admin/list", data);

// admin walet
export const fetchAdminWallet = (data) => get("/wallet/list", data);
export const fetchsubscriptionEarning = (data) => get("/wallet/subscription-histrory", data);
export const fetchorderEarning = (data) => get("/wallet/order-histrory", data);

// user address
export const fetchUserAddress = (data) => get("/order/address/list", data);
export const changeUserAddressStatus = (data) => get("/order/address/status", data);
export const postUserAddress = (data) => post("/order/address/create", data);

export const fetchNearestHub = (data) => get("/hub/find-nearest", data);
export const getDeliveryCharge = (data) => post("/revenue/calculate-distance", data);

// admin withdraw history 
export const fetchAdminWithdrawHistory = (data) => get("/withdraw/list/admin", data);
export const adminWithdrawStatus = (data) => post("/withdraw/status", data);
export const vendorWalletByAdmin = (data) => get("/wallet/vendor/list/by-admin", data);
...
export const adminMessaged = (data) => get("/message/admin/chat", data);



//dashboard
export const getDashboadData=(data)=> get("/dashboard/admin/tables",data);
export const getDashboardCount=(data)=>get("/dashboard/admin",data);
//dashboard vendor
export const getVendorDashboard=(data)=>get("/dashboard/vendor",data);


// vendor customer list 

export const fetchVendorCustomer = (data) => get("/order/customers", data);
